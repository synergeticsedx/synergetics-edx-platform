...
if settings.FEATURES["ENABLE_MICRO_MASTERS"]:
    urlpatterns += patterns(
        ...
        url(r'^program-enrollment/$', 'program_enrollment', name='program-enrollment'),
        url(r'^program-coupon-redemption/$', 'program_coupon_redemption', name='program-coupon-redemption'),
        url(r'^program-generated-certificate/$', 'program_generated_certificate', name='program-generated-certificate'),
    )
